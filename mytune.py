...
STRINGS = {
    "ko": {
        ...
        "header_help": "[S]검색 [F]즐겨찾기 [H]기록 [M]메인 [A]추가/삭제 [SPC]재생/중지 [Q]이전",
        "help_guide": "[↑/↓]이동 [Enter]선택 [S]검색 [F]즐겨찾기 [H]기록 [M]메인 [A]추가/삭제 [SPACE]재생/중지 [Q]이전",
        "menu_main": "☰ 메인 메뉴",
    ...
    "en": {
        ...
        "header_help": "[S]Search [F]Favorites [H]History [M]Main [A]Add/Del [SPC]Play/Pause [Q]Back",
        "help_guide": "[↑/↓]Move [Enter]Select [S]Search [F]Favorites [H]History [M]Main [A]Add/Del [SPACE]Play/Pause [Q]Back",
        "menu_main": "☰ Main Menu",
