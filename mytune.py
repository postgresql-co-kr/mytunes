...
STRINGS = {
    "ko": {
        ...
        "header_help": "[S/1]검색 [F/2]즐겨찾기 [R/3]기록 [M/4]메인 [SPC]재생/정지 [Vol]+/- [Q/6]이전 [A/5]추가",
        "help_guide": "[j/k]이동 [l/En]선택 [h/q]뒤로 [S/1]검색 [F/2]즐겨찾기 [R/3]기록 [M/4]메인 [A/5]추가 [SPC]재생/정지",
        "menu_main": "☰ 메인 메뉴",
    ...
    "en": {
        ...
        "header_help": "[S/1]Search [F/2]Favs [R/3]Hist [M/4]Main [SPC]Play/Pause [Vol]+/- [Q/6]Back [A/5]Add",
        "help_guide": "[j/k]Move [l/En]Select [h/q]Back [S/1]Srch [F/2]Fav [R/3]Hist [M/4]Main [A/5]Add [SPC]P/P",
        "menu_main": "☰ Main Menu",
